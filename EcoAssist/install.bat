...
call %EA_CONDA_EXE% env remove -n ecoassistcondaenv-yolov11
call %EA_CONDA_EXE% env create --file EcoAssist\envs\classifier-yolov11-windows.yml
...
"%EA_PIP_EXE_CLA%" install ultralytics==8.3.15
